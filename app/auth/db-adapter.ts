...
if (!accessKeyId || !secretAccessKey) {
  throw new Error("DYNAMODB_AWS_ACCESS_KEY and DYNAMODB_AWS_SECRET_KEY must be set");
}
...
export const dynamodbAdapter = DynamoDBAdapter(dynamodbClient, { tableName: "stock-trend-strategy-users" });
